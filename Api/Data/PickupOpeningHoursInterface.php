...
interface PickupOpeningHoursInterface extends ExtensibleDataInterface
{
     ...
     *
     * @param \Walmart\BopisInventorySourceApi\Api\Data\PickupOpeningHoursExtensionInterface|null $extensionAttributes
     *
     * @return void
     */
    public function setExtensionAttributes(\Walmart\BopisInventorySourceApi\Api\Data\PickupOpeningHoursExtensionInterface $extensionAttributes): void;

    /**
     * Get Extension Attributes of Pickup Location.
     *
     * @return \Walmart\BopisInventorySourceApi\Api\Data\PickupOpeningHoursExtensionInterface|null
     */
